...
-- select * from khach_hang where (curdate()-ngay_sinh>(18*30*365) and curdate()-ngay_sinh<(50*50*365)) and dia_chi in ('Quảng Trị', 'Đà Nẵng');
...
-- từ bảng dich_vu_di_kem, hop_dong_chi_tiet) cho tất cả các khách hàng đã từng đặt phòng. (những khách hàng nào chưa từng đặt 
...
-- 7.Hiển thị thông tin ma_dich_vu, ten_dich_vu, dien_tich, so_nguoi_toi_da, chi_phi_thue, ten_loai_dich_vu
 -- của tất cả các loại dịch vụ đã từng được khách hàng đặt phòng trong năm 2020 nhưng chưa từng
...
-- ten_dich_vu, so_luong_dich_vu_di_kem (được tính dựa trên việc sum so_luong ở dich_vu_di_kem), tien_dat_coc của tất cả các dịch vụ đã từng
...
-- 19.	Cập nhật giá cho các lên gấp đôi.dịch vụ đi kèm được sử dụng trên 10 lần trong năm 2020 */
